    ...
    function a(r, a) {
        ...
        return i(a, function() {
            ...
            function i(e, n) {
                ...
                for (var l = 0; l < e.length; l++) if(e[l].contentType != "street") r = e[l], a = x("valueFormat")(r, n), i = x("labelFormat")(r, n), o = t('<a data-val="' + a + '">' + i + "</a>"), o.data("kladr-object", r), t("<li></li>").append(o).appendTo(V)
            }
            ...
            return t.each(e, function(e, i) {
                ...
                if ("object" === t.type(i)) {
                    for (o = 0; o < n.length; o++)
                        if (n[o] == i.id) return;
                    n.push(i.id), l = i.name, u = i.typeShort + ". ", a
                } else l = i;
                r && (r += ", "), r += u + l
            }), r = (a ? a + ", " : "") + r
        }
